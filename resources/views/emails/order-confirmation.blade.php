                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:20px;font-weight:bold;line-height:22px;text-align:center;color:#525252;">
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                ...
                                                <p>Thank you for  completing your order, have fun reading.</p>
                                            </div>
                                        ...
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <table 0="[object Object]" 1="[object Object]" 2="[object Object]"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0 0 0 15px;" align="right">₦{{ $order->amount }}
                                                    </td>
                                                </tr>
                                                {{-- <tr>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:16px;text-align:left;color:#a2a2a2;">
                                                <p style="font-weight:bold;"><a href="{{asset('storage/'.$order->book->bookfile)}}" target="_blank">Your download link</a></p>
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                ...
                                                {{-- <a
                                                    href="https://www.htmlemailtemplates.net"
