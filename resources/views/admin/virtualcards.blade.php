                                ...
                                <tbody>
                                    @forelse ($cards as $card)
                                        <tr>
                                            ...
                                            <td><button class="btn btn-primary" onClick="withdrawFromCard('{{ $card->card_id }}')">Withdraw from
                                                    card</button>
                                            </td>
                                            <td> 
                                              @if($card->card_id != "")
                                              <button class="get-card btn btn-primary"
                                                    ...
                                                    card detail</button>
                                                    @else
                                                    <span style="font-weight:bold; color:red;">Card was not created successfully on the paygate</span>
                                                    @endif
                                            </td>
                                              ...
                                              @if($card->card_id != "")
                                                 ...
                                                 @if($card->is_active == 1)
                                                   <button class="block-card btn btn-primary"
                                                    data-url="{{ route('block.card', ['card' => $card->id]) }}">Block card
                                                  </button>
                                                  @else
                                                  <button class="unblock-card btn btn-primary"
                                                    data-url="{{ route('unblock.card', ['card' => $card->id]) }}">Unblock card
                                                  </button>
                                            ...
                                            <td>
                                              <button class="btn btn-primary" onClick="getTransactions('{{ $card->card_id }}')">View transactions</button>
                                            </td>
