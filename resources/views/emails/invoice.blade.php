                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:20px;font-weight:bold;line-height:22px;text-align:center;color:#525252;">
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:left;color:#525252;">
                                                ...
                                                <p>Thank you for placing your order, we are glad to be considered worthy to serve you</p>
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <table 0="[object Object]" 1="[object Object]" 2="[object Object]" border="0" style="cellspacing:0;color:#000;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;">
                                                ...
                                                <tr>
                                                <td style="padding: 5px 15px 5px 0;">{{$order->book->name}}</td>
                                                <td style="padding: 0 15px;">{{$order->quantity}}</td>
                                                <td style="padding: 0 0 0 15px;" align="right">₦{{$order->amount}}</td>
                                                </tr>
                                                {{-- <tr>
                                                    <td style="padding: 0 15px 5px 0;">Shipping + Handling</td>
                                                    <td style="padding: 0 15px;">1</td>
                                                    <td style="padding: 0 0 0 15px;" align="right">₦0</td>
                                                </tr>
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                 ...
                                                 <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    <td style="padding: 5px 15px 5px 0; font-weight:bold">Status</td>
                                                    <td style="padding: 0 15px;"></td>
                                                <td style="padding: 0 0 0 15px; font-weight:bold" align="right">@if($order->status ==1)<span style="color:green; font-weight:bold;">PAID</span> @endif @if($order->status ==0)<span style="color:red; font-weight:bold;">UNPAID</span> @endif</td>
                                                </tr>
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    <td style="padding: 5px 15px 5px 0; font-weight:bold">Reference</td>
                                                    <td style="padding: 0 15px;"></td>
                                                <td style="padding: 0 0 0 15px; font-weight:bold" align="right">#{{$order->reference}}</td>
                                                </tr>
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    <td style="padding: 5px 15px 5px 0; font-weight:bold">TOTAL</td>
                                                    <td style="padding: 0 15px;"></td>
                                                <td style="padding: 0 0 0 15px; font-weight:bold" align="right">₦{{$order->amount}}</td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:16px;text-align:left;color:#a2a2a2;">
                                                <p style="font-weight:bold;">Once your payment is confirmed you will get a notification email</p>
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                                Best regards,<br><br> Book store Manager
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:0;word-break:break-word;">
                                                            ...
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                16 Abraham,Adesanya ,Lagos State, Nigeria.
                                                            </div>
